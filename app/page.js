...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section className="border-b-4 border-ink bg-turf text-chalk">
        <div className="mx-auto max-w-5xl px-6 py-20">
          ...
          <div className="mt-8 flex gap-4">
            <Link
              href="/programs"
              className="bg-brass px-6 py-3 font-mono text-sm font-medium uppercase tracking-wide text-ink hover:bg-brass/90"
            >
              See Programs
            </Link>
            <Link
